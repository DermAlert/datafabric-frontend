...
export default function NewSilverDatasetPage() {
  ...
  // Step 4: Equivalence
  const [selectedColumnGroups, setSelectedColumnGroups] = useState<number[]>([]);
  ...
  const handleTransformationChange = (id: string, field: keyof Transformation, value: any) => {
  ...
  const handleFilterConditionChange = (id: string, field: keyof FilterCondition, value: string) => {
